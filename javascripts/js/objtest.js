...
var myJson = "http://jsonplaceholder.typicode.com/albums/1/photos";
//sfetch(myJson).then(blob => blob.json()).then(data =>console.log(myJson[0]));
var getData = fetch(myJson).then(blob => blob.json());
var outPut = "";
 var outPut = "";
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="text-center thumbnail">
                    <img class="img-responsive" src="${.then(data =>getData[i]}"  >
                </div>
                <div class="contents">
                    <h3 class="name">
